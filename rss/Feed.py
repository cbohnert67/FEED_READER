...
class Feed:
    ...
    def getInfo(self):
        info = "\n"
        info += self.getTitle().upper()
        info += "\n\n"
        info += self.getDescription()
        info += "\n\n"
        info += "Published on {}".format(self.getPublished())
        info += "\n\n"
        info += "Number of entries : {}".format(self.getLength())
        info += "\n"
        return info
    ...
    #     """ Prints the feed's entry of index idx"""
    #     print(str(self.getEntry(idx)))


    # def printEntries(self):
    #     """ Prints all the feed's entries """
    #     for entry in self.getEntries():
    #         print(str(entry))

    # def printTitles(self):
    #     """ Prints all the entry's title """
    #     titles = ""
    #     for entry in self.getEntries():
    #         titles += "- "
...
class Entry:
    ...
    def __str__(self) -> str:
        s = "\n"
        s += self.getTitle().upper()
        s += "\n"
        s += self.getLink()
        s += "\n"
        s += "Published on {}".format(self.getPublished())
        s += "\n"
